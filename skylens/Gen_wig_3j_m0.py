...
import zarr
import time
lmax=3500 #~nside*3.. or the lmax to be used in the analysis.
wlmax=2100 #This needs to be 2Xlmax in general, unless you are certain window is narrow in ell space.
m1=0
m2=0
m3=0
