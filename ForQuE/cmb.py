...
class CMB(object):
   ...
   def __init__(self):
      ...
      # lensed CMB
      data = np.genfromtxt("./ForQuE/input/universe_Planck15/camb/lensedCls.dat")
      ...
      data = np.genfromtxt("./ForQuE/input/cmb/digitizing_SZ_template/tSZ.txt")
      ...
      data = np.genfromtxt("./ForQuE/input/cmb/digitizing_SZ_template/kSZ.txt")
      ...
      data = np.genfromtxt ("./ForQuE/input/cmb/digitizing_tSZCIB_template/minus_tSZ_CIB.txt")
   ...
   def testInterpCMB(self):
      data = np.genfromtxt("./ForQuE/input/universe_FerraroHensley14/lensedCls.dat")
...
class CIBWuDore17(CMB):
   ...
   def loadTabulatedCIB(self, nu1, nu2):
      ...
      path = "./ForQuE/input/cib_wu_dore_17/CL_1h2h_"+str(int(nu1/1.e9))+"x"+str(int(nu2/1.e9))+"_base.dat"
